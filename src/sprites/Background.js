...
export default class Background {
  constructor(scene) {
    ...
    this.carrierConfig = { width: 8, height: 2, x: 20, y: 180, speed: -0.0001 };
  ...
  update(delta, planeModel) {
    ...
    if (this.carrier.getTopRight().x - this.cloudBuffer < 0) {
      this.carrier.setX(properties.width + this.cloudBuffer + this.carrierConfig.x);
    }
  }
